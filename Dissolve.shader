...
//values used by the script attached
uniform float start_time = 99999999.0;
uniform float duration = 1.0;


//noise effect, see fog.shader for more info
...
//please see the attached script for info about how we burn it when you start the scnee
void fragment() {
